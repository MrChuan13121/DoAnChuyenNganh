...
function Delete({ setModalDele, idPersonnel }) {
  const deletePersonnel = async (idPersonnel) => {
    const tokenString = localStorage.getItem("token");
    await fetch(ADDRESS + "/user/" + idPersonnel, {
      method: "DELETE",
      headers: {
    ...
    <div className="modalBackground-del">
      <div className="modalContainer-del">
        ...
        <div className="footer">
          ...
          <button
            onClick={async () => {
              await deletePersonnel(idPersonnel._id);
              setModalDele(false);
            }}
          >
            Xoá
